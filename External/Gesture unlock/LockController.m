...
//            UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"密码设置成功" message:@"请输入密码解锁" preferredStyle:UIAlertControllerStyleAlert];
//            
//            UIAlertAction *resetAction = [UIAlertAction actionWithTitle:@"确认"style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
//                
//                NSLog(@"click");
//            }];
//            
